...
-- D4h crystal field and Oh ligand field with LMCT and MLCT capability.
--
-- Atomic Slater integrals and SOC constants are read from the .inp_quanty file
-- (auto-populated by generate_inp_quanty.py via parse_rcn.py).
-- This makes the script generic across elements and oxidation states for L-edge.
--
-- Based on greenMLCT_Co3d6_D4h_RCN_conf_job.lua (preserved unchanged for posterity).
...
InitialRestrictions = {NFermions, NBosons, {'111111 0000000000', NE_2p, NE_2p},
                                           {'000000 1111111111', NE_3d, NE_3d}}

FinalRestrictions = {NFermions, NBosons, {'111111 0000000000', NE_2p - 1, NE_2p - 1},
