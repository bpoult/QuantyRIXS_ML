...
---------------------------------------------------------
-- Input
config_name = 'CoTerpy_2026_02_02_4.inp_quanty'
...
for line in io.lines(config_name) do
  ...
  if line ~= '' and string.sub(line,0,1) ~= '#' then
    ...
    if x[1] == 'scale_i' then
      scale_i = tonumber(x[3])
    end
    if x[1] == 'scale_f' then
      scale_f = tonumber(x[3])
    end
...
spec_config_name = 'CoTerpy_2026_02_02.inp_rixs'
...
F2_3d_3d_i = 12.663 * scale_i
F4_3d_3d_i = 7.917 * scale_i
F0_3d_3d_i = U_3d_3d_i + 2 / 63 * F2_3d_3d_i + 2 / 63 * F4_3d_3d_i

F2_3d_3d_f = 13.422 * scale_f
F4_3d_3d_f = 8.395 * scale_f
F0_3d_3d_f = U_3d_3d_f + 2 / 63 * F2_3d_3d_f + 2 / 63 * F4_3d_3d_f
F2_2p_3d_f = 7.900 * scale_f
G1_2p_3d_f = 5.951 * scale_f
G3_2p_3d_f = 3.385 * scale_f
...
if energy_end > L3_L2_split then
  ...
  RIXS_L3 = CreateResonantSpectra(H_f, H_i, {Tx_2p_3d, Ty_2p_3d, Tz_2p_3d}, {Tx_3d_2p, Ty_3d_2p, Tz_3d_2p},
          ...
          {'Emin2', E2min}, {'Emax2', E2max}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}})
